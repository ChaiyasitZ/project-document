...
\fontSixTeen{
\begin{tabbing}
    เรื่อง  \= เว็บแอปพลิเคชันเพื่อการคอนฟิกด้วยวิธี NETCONF ผ่าน LLM       %ชื่อโปรเจ็คภาษาไทย
    \\
    โดย  \> นายชัยสิทธิ์ มินทกร     %ชื่อผู้จัดทำ1 
    ...
    \\
         \> หลักสูตรวิทยาศาสตรบัณฑิต  สาขาวิชาวิศวกรรมสารสนเทศและเครือข่าย % กรณีเป็นนักศึกษาหลักสูตร IT
...
\makebox[7cm][c]{(อาจารย์ ดร.ศรายุทธ ธเนศสกุลวัฒนา)}       %ระบุชื่อประธานกรรมการ
\end{flushleft}

\vspace{1.5em}
\begin{flushleft}
\makebox[7cm][l]{\rule{7cm}{0.4pt} กรรมการ} \\
\makebox[7cm][c]{(ผู้ช่วยศาสตราจารย์ ดร.สุพาภรณ์ ซิ้มเจริญ)}            %ระบุชื่อกรรมการ
\end{flushleft}

\vspace{1.5em}
\begin{flushleft}
\makebox[7cm][l]{\rule{7cm}{0.4pt} กรรมการ} \\
\makebox[7cm][c]{(อาจารย์ ดร.วัชรชัย คงศิริวัฒนา)}       %ระบุชื่ออาจารย์ที่ปรึกษาโปรเจ็ค
\end{flushleft}
